...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-sm-2">
      ...
      <h4>10+ hours of video content</h4>
    </div><!-- col -->
    <div class="col-sm-2">
...
<div class="container">
  <div class="row">
    <div class="col-sm-8 col-sm-offset-2">
      ...
      <iframe width="100%" height="415" src="https://www.youtube.com/embed/ZGWKKI2ky8w" frameborder="0" allowfullscreen></iframe>
    </div><!-- col -->
  </div><!-- row -->
</div><!-- container -->
...
<div class="container">
  <div class="row">
    <div class="col-sm-8 col-md-6">
      <div class="row">
        <div class="col-lg-8">
          <h2>Your instructor <small>Chad Bradley</small></h2>
        </div><!-- col -->
        <div class="col-lg-4">
          <a href="https://www.twitter.com/theRingleman" target="_blank" class="badge social twitter"><i class="fa fa-twitter"></i></a>
          <a href="https://www.facebook.com/sam.ringleman" target="_blank" class="badge social facebook"><i class="fa fa-facebook"></i></a>
          <a href="https://plus.google.com/110451059259438673039" target="_blank" class="badge social gplus"><i class="fa fa-google-plus"></i></a>
        </div><!-- col -->
      </div><!-- row -->
...
<div class="container">
  <div class="row">
    <div class="col-sm-8 col-sm-offset-2">
      <h2>What people are saying about Chad Bradley</h2>
      ...
      </div> <!-- row --><div class="row testimonial">
        <div class="col-sm-4">
