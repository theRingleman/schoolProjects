...
<?php wp_footer(); ?>
	...
	<footer>
		<div class="container">
			...
			<div class="col-sm-3">
				<p class="pull-right">&copy; 2016 Sam Ringleman</p>
			</div><!-- col -->
		</div><!-- container -->
	</footer>
				...
				<div class="modal-body">
					...
					<form class="form-inline" role="form">
						<div class="form-group">
							<label for="subscibe-name" class="sr-only">Your first name</label>
							<input type="text" class="form-control" id="subscribe-name" placeholder="Your first name">
						</div><!-- form-group -->
						<div class="form-group">
							<label for="subscibe-email" class="sr-only">Your email</label>
